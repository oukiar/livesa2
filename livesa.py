...
class ProductFilter(Fieldset):
    def __init__(self, **kwargs):
        ...
        self.productos = DropButton(text='[color=000000]Productos[/color]', 
                                    ...
                                    values= {'AGUARDIENTE':{'key':'AC', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'ALCOHOL':{'key':'AL', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'ANIS':{'key':'AN', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'DESTILADO':{'key':'BA', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'HABANERO':{'key':'HB', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'JEREZ':{'key':'JZ', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'LICOR':{'key':'LC', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'MEZCAL':{'key':'MZ', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'PARRAS':{'key':'PA', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'RON':{'key':'RN', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'SANGRITA':{'key':'SG', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'SIDRA AMBAR':{'key':'SB', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'SIDRA ROSADA':{'key':'SR', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'TEQUILA':{'key':'TQ', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'VERMOUTH':{'key':'VT', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'VINO DE CONSAGRAR':{'key':'VG', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'VODKA':{'key':'VK', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'ESTUCHE MINIATURA MEXICANO':{'key':'E1', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'ESTUCHE MINIATURA MTY':{'key':'E2', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'ESTUCHE MINIATURA REGIONAL':{'key':'E3', 'marcas':[], 'capacidades':[], 'tipos':[]},
                                    'CHAROLA MINIATURA MEXICANO':{'key':'E4', 'marcas':[], 'capacidades':[], 'tipos':[]}
                                    })
                                    
        self.marcas = DropButton(text='[color=000000]Marcas[/color]',
                                    item_cls=CheckItem,
                                    item_textcolor='000000',
                                    values = {'38':{'key':'TR', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'AJITA':{'key':'AJ', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'AMECA Y ANAMARINA':{'key':'AM', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'BARANTRO':{'key':'BT', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'BOLA DE ORO':{'key':'BL', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'CAFKA':{'key':'CF', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'CAÑONAZO':{'key':'CA', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'CHOPERENA':{'key':'CN', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'DEL CORAZON':{'key':'CZ', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'DIVINO':{'key':'DV', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'DOS CORONAS':{'key':'DC', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'EL CHORRITO':{'key':'CH', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'EL JINETE':{'key':'JT', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'EL TIGRE':{'key':'TG', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'FAROLAZO':{'key':'FR', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'FURKEN':{'key':'FU', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'GRAN PEÑUELA':{'key':'GP', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'HIJOS DE VILLA':{'key':'HV', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'LA LUPE':{'key':'LL', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'LAJITA':{'key':'LJ', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'MARINA':{'key':'MR', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'MATACAÑA':{'key':'MT', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'MOCAMBO':{'key':'MM', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'OTELO':{'key':'TL', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'PETROVA':{'key':'PT', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'PETROVA KINGEBRA':{'key':'PK', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'PLUMA ROJA':{'key':'PR', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'TORINO':{'key':'TR', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'VILLA RICA':{'key':'HV', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'VILLALOBOS':{'key':'VL', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'VILLALOBOS PLATINUM':{'key':'VP', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'VINO DE CONSAGRAR':{'key':'GC', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'MEXICANO':{'key':'MX', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'MONTERREY':{'key':'MT', 'productos':[], 'capacidades':[], 'tipos':[]},
                                    'SURTIDO REGIONAL':{'key':'RG', 'productos':[], 'capacidades':[], 'tipos':[]}
                                    })
                                    
        self.capacidades = DropButton(text='[color=000000]Capacidades[/color]',
                                    item_cls=CheckItem,
                                    item_textcolor='000000',
                                    values = {'0.050':{'key':'00', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.200':{'key':'20', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.200':{'key':'21', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.250':{'key':'25', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.355':{'key':'35', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.440':{'key':'44', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.500':{'key':'50', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.690':{'key':'69', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.700':{'key':'70', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.750':{'key':'75', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '0.950':{'key':'95', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '1.000':{'key':'01', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '1.500':{'key':'15', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '1.690':{'key':'16', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '1.750':{'key':'17', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '3.970':{'key':'39', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '5.000':{'key':'50', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '20.000':{'key':'02', 'productos':[], 'marcas':[], 'tipos':[]},
                                    '200.000':{'key':'GR', 'productos':[], 'marcas':[], 'tipos':[]}
                                    })
                                    
        self.tipos = DropButton(text='[color=000000]Tipos[/color]',
                                    item_cls=CheckItem,
                                    item_textcolor='000000',
                                values = {'BLANCO Y C/PERA':{'key':'11', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'BLANCO Y CAFE ESPECIAL':{'key':'12', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'BLANCO LUJO Y LICOR C/GUSANO':{'key':'13', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'ESPECIAL MONTERREY':{'key':'14', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'AÑEJO ESPECIAL':{'key':'15', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    '34% Alc. Vol.':{'key':'19', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'ORO':{'key':'21', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'ORO LUJO':{'key':'22', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'ORO EXTRA':{'key':'23', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'REPOSADO':{'key':'31', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'REPOSADO ANIVERSARIO':{'key':'32', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'REPOSADO LUJO':{'key':'36', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'AÑEJO':{'key':'41', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'AÑEJO LUJO':{'key':'43', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'SOLERA':{'key':'51', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'STANDARD':{'key':'61', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'STANDARD LUJO':{'key':'63', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'DESTILADO DE AGAVE':{'key':'64', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    '10 AÑOS BUCANERO':{'key':'70', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'CIRUELA Y 15 AÑOS':{'key':'71', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'DURAZNO Y 20 AÑOS':{'key':'72', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'MANZANA Y 20 AÑOS ARTE':{'key':'73', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'MEMBRILLO':{'key':'74', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'NANCHE DULCE':{'key':'75', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'NARANJA':{'key':'76', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'PIÑA':{'key':'77', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'ZARZAMORA':{'key':'78', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'LIMON':{'key':'79', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'MANZANA DULCE':{'key':'81', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'NANCHE':{'key':'82', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'TEJOCOTE':{'key':'83', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'HIERBA DEL BURRO':{'key':'84', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'HIERBA MAESTRA':{'key':'85', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'HERBAL Y PLATANO':{'key':'86', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'MELON':{'key':'87', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'MENTA BLANCA':{'key':'88', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'BLUE CURACAO':{'key':'89', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'CAFE':{'key':'91', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'CAFE MINI REDONDA':{'key':'92', 'productos':[], 'marcas':[], 'capacidades':[]},
                                    'ESTUCHES MINI Y SIN TIPO':{'key':'99', 'productos':[], 'marcas':[], 'capacidades':[]}
                                    })
    ...
    def selected_product(self, w, val):
        ...
        print self.productos.values[producto]
